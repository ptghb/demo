...
public class UserController {
    ...
    public ResultInfo<List<UserEntity>> getUsersByPage(@RequestParam Integer pageNo,@RequestParam Integer pageSize) {
    ...
    public ResultInfo<UserEntity> getUser(@PathVariable Long id) {
    ...
    public ResultInfo<UserEntity> addUser(@ModelAttribute UserEntity user) { 
    ...
    public ResultInfo<UserEntity> updUser(@ModelAttribute UserEntity user) {
		user = userSerivce.save(user);
        ResultInfo<UserEntity> result = new ResultInfo<UserEntity>(user);
        return result;
    } 
